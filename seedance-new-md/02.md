...
<span id="8H64ladJ"></span>

# 接入说明

<span id="cnwTuNhR"></span>
...
<span id="LdnKRYAo"></span>

## 提交任务

<span id="KgyxysSj"></span>

### **提交任务请求参数**

<span id="hfvyKAco"></span>
...
|req_key |string |必选 |服务标识<br><br>取固定值：**jimeng_t2v_v30_1080p** |
...
<span id="czbENbTq"></span>

## 查询任务

<span id="XyNSUmbM"></span>

### **查询任务请求参数**

<span id="nA5Nn2GW"></span>
...
<span id="MWPxYxTy"></span>

### 查询任务返回参数

<span id="BjYtprMH"></span>

#### **通用返回参数**

请参考[通用返回字段及错误码]([https://www.volcengine.com/docs/6444/69728](https://www.volcengine.com/docs/6444/69728))

<span id="6G08NqDh"></span>
...
<span id="oORdwD7f"></span>

## 错误码

<span id="XIt7qXuR"></span>

### **通用错误码**

请参考[通用返回字段及错误码]([https://www.volcengine.com/docs/6444/69728](https://www.volcengine.com/docs/6444/69728))

<span id="xyIWI1sb"></span>
